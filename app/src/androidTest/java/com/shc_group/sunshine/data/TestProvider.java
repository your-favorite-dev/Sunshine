...
import com.shc_group.sunshine.data.WeatherContract.LocationEntry;
import com.shc_group.sunshine.data.WeatherContract.WeatherEntry;
...
public class TestProvider {
    ...
    public void testBulkInsert() {
        ...
        cursor = mContext.getContentResolver().query(
                ...
                null, // cols for "where" clause
                null, // values for "where" clause
                WeatherEntry.COLUMN_DATE + " ASC"  // sot order == by DATE ASCENDING
        );
